...
class Detection(QThread):
    ...
    def __init__(self):
        ...
        self.skip_frames = 5  # Procesa el frame cada 5 frames
        ...
        # Inicializa el nodo ROS y suscríbete al tópico de la cámara
    ...
    def callback_imagen(self, msg):
        if not self.stopped:
            ...
            frame = cv2.resize(frame, (640, 480))  # Ajusta el tamaño del frame si es necesario
    ...
    def run(self):
        rospy.spin()  # Mantiene el nodo ROS en ejecución
